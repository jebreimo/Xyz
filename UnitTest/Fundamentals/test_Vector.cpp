...
namespace {
    ...
    void test_rotated()
    {
        ...
        Y_ASSERT(equivalent(rotated(makeVector(100, 0), toRadians(30)),
                            makeVector(50 * std::sqrt(3), 50.0), 1e-12));
        Y_ASSERT(equivalent(rotated(makeVector(100, 0), toRadians(45)),
                            makeVector(100 / sqrt2, 100 / sqrt2), 1e-12));
        Y_ASSERT(equivalent(rotated(makeVector(100, 0), toRadians(60)),
                            makeVector(50.0, 50 * std::sqrt(3)), 1e-12));
        Y_ASSERT(equivalent(rotated(makeVector(0, 100), toRadians(-60)),
                            makeVector(50 * std::sqrt(3), 50.0), 1e-12));
        Y_ASSERT(equivalent(rotated(makeVector(0, 100), toRadians(-45)),
                            makeVector(100 / sqrt2, 100 / sqrt2), 1e-12));
        Y_ASSERT(equivalent(rotated(makeVector(0, 100), toRadians(-30)),
                            makeVector(50.0, 50 * std::sqrt(3)), 1e-12));
