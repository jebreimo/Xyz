...
TEST_CASE("Plane: projection matrix on")
{
    ...
    constexpr Plane<double> plane{{2, -1, 0}, {0, 1, 1}};
...
TEST_CASE("Plane: intersection with diagonal plane")
{
    ...
    using Plane = Xyz::Plane<float>;
    Plane plane{{-1.5, 2, 5.5}, {-1, -1, 1}};
    SECTION("Intersection with yz plane")
    {
    ...
    SECTION("Intersection with xz plane")
    {
    ...
    SECTION("Intersection with xy plane")
    {
