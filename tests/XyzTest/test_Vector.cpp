...
namespace {
    ...
    void test_basics_2d()
    {
        ...
        Y_EQUAL(v[0], 3);
        Y_EQUAL(v[1], 4);
        Y_EQUAL(multiply(u, v), make_vector2<double>(6, 4));
        ...
        Y_EQUAL(divide(6, u), make_vector2<double>(3, 6));
        Y_EQUAL(u += v, make_vector2<double>(5, 5));
        Y_EQUAL(u -= v, make_vector2<double>(2, 1));
        Y_EQUAL(u *= 3, make_vector2<double>(6, 3));
        Y_EQUAL(u /= 2, make_vector2<double>(3.0, 1.5));
        Y_EQUAL(multiply_assign(u, v), make_vector2<double>(9, 6));
        Y_EQUAL(u *= 2, make_vector2<double>(18, 12));
        Y_EQUAL(divide_assign(u, v), make_vector2<double>(6, 3));
        Y_EQUAL(dot(u, v), 30);
    ...
    void test_basics_4d()
    {
        ...
        Y_EQUAL(v[2], -1);
        Y_EQUAL(v[3], -2);
        Y_EQUAL(multiply(u, v), make_vector4<double>(6, 4, -4, -6));
        ...
        Y_EQUAL(divide(12, u), make_vector4<double>(6, 12, 3, 4));
        Y_EQUAL(u += v, make_vector4<double>(5, 5, 3, 1));
        Y_EQUAL(u -= v, make_vector4<double>(2, 1, 4, 3));
        Y_EQUAL(u *= 3, make_vector4<double>(6, 3, 12, 9));
        Y_EQUAL(u /= 2, make_vector4<double>(3.0, 1.5, 6.0, 4.5));
        Y_EQUAL(multiply_assign(u, v), make_vector4<double>(9, 6, -6, -9));
        Y_EQUAL(u *= 2, make_vector4<double>(18, 12, -12, -18));
        Y_EQUAL(divide_assign(u, v), make_vector4<double>(6, 3, 12, 9));
